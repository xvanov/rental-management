"""Data models for Wake Electric utility bills."""
...
class EnergyBillData:
    """Parsed data from a Wake Electric utility bill."""
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "facility_charge": self.facility_charge,
            "taxes": self.taxes,
...
@dataclass
class AccountInfo:
    """Information about a Wake Electric account from the portal."""
    account_number: str
    service_address: str
