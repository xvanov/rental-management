#!/usr/bin/env python3
"""
Graham Utilities Bill Fetcher

Main entry point for fetching and parsing Graham utility bills via Edmunds WIPP portal.
...
from models import GrahamBillData, DocumentType, FetchResult
...
def parse_existing_pdfs(pdf_dir: Path) -> list[GrahamBillData]:
...
def output_json(bills: list[GrahamBillData], output_path: Path = None):
...
def main():
    parser = argparse.ArgumentParser(
        description="Graham Utilities Bill Fetcher",
    ...
    if args.test:
        ...
        # Fetch from portal
        print("Fetching bills from Graham Utilities portal...")
