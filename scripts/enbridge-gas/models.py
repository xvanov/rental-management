"""Data models for Enbridge Gas utility bills."""
...
@dataclass
class GasBillData:
    """Parsed data from an Enbridge Gas utility bill."""
    ...
    # Usage info
    therms_used: float = 0.0
    meter_number: Optional[str] = None

    # Charges breakdown
    gas_charges: float = 0.0
    basic_facilities_charge: float = 0.0
    taxes: float = 0.0
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "therms_used": self.therms_used,
            "meter_number": self.meter_number,
            "gas_charges": self.gas_charges,
            "basic_facilities_charge": self.basic_facilities_charge,
            "taxes": self.taxes,
...
@dataclass
class AccountInfo:
    """Information about a gas account from the portal."""
    account_number: str
    service_address: str
...
class FetchResult:
    ...
    bills: list[GasBillData] = field(default_factory=list)
