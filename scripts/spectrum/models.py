"""Data models for Spectrum utility bills."""
...
@dataclass
class InternetBillData:
    """Parsed data from a Spectrum utility bill."""
...
@dataclass
class AccountInfo:
    """Information about a Spectrum account from the portal."""
    account_number: str
    service_address: str
...
class FetchResult:
    ...
    bills: list[InternetBillData] = field(default_factory=list)
