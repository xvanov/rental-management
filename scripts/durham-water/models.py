"""Data models for Durham Water utility bills."""
...
@dataclass
class WaterBillData:
    """Parsed data from a Durham Water utility bill."""
    ...
    # Billing period (for regular bills)
...
@dataclass
class AccountInfo:
    """Information about a water account from the portal."""
    account_number: str
    service_location: str
...
class FetchResult:
    ...
    bills: list[WaterBillData] = field(default_factory=list)
