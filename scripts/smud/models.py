"""Data models for SMUD (Sacramento Municipal Utility District) bills."""
...
@dataclass
class SmudBillData:
    """Parsed data from a SMUD utility bill."""
...
@dataclass
class AccountInfo:
    """Information about a SMUD account."""
    account_number: str
    service_address: str
...
class FetchResult:
    ...
    bills: list[SmudBillData] = field(default_factory=list)
